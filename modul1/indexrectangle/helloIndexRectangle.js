...
/**
 * Et WebGL-program som tegner en enkel trekant vha. indeksbuffer.
...
function initBuffers(gl) {
	...
	// Definerer fire trekanter vha. 5 vertekser (CCW):
...
function draw(gl, baseShaderInfo, buffers) {
	...
	// Tegn vha. drawElements() i stedet for drawArrays():
